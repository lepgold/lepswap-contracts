...
##################################################
#            Changes to MasterLepV2             #
##################################################

# SafeTransfer simplification
perl -0777 -i -pe 's/safeT/t/g' contracts/MasterLepV2.sol

# Adding public to totalAllocPoint
perl -0777 -i -pe 's/uint256 totalAllocPoint/uint256 public totalAllocPoint/g' contracts/MasterLepV2.sol

# Adding virtual to sushiPerBlock()
perl -0777 -i -pe 's/function sushiPerBlock\(\) public view returns/function sushiPerBlock\(\) public view virtual returns/g' contracts/MasterLepV2.sol
