...
describe("KashiGoldMaker", function () {
  before(async function () {
    await prepare(this, ["SushiMakerKashi", "LepGold", "SushiMakerKashiExploitMock", "ERC20Mock", "UniswapV2Factory", "UniswapV2Pair", "BentoBoxV1", "KashiPairMediumRiskV1", "PeggedOracleV1"])
  })
